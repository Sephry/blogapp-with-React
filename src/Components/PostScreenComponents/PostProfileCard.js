...
const PostProfileCard = () => {
    ...
    return (
        ...
        <div className="w-full lg:w-1/4 m-auto mt-12 max-w-screen-sm p-4 border-t border-b md:border md:rounded">
            ...
            <div className="space-y-4 text-center divide-y divide-gray-700">
                ...
                <div className="flex justify-center pt-2 space-x-4 align-center">
                    <a rel="noopener noreferrer" href="#" aria-label="GitHub" className="p-2 rounded-md dark:text-gray-700 hover:dark:text-violet-400">
                    ...
                    <a rel="noopener noreferrer" href="#" aria-label="Linkedin" className="p-2 rounded-md dark:text-gray-700 hover:dark:text-violet-400">
                    ...
                    <a rel="noopener noreferrer" href="#" aria-label="Instagram" className="p-2 rounded-md dark:text-gray-700 hover:dark:text-violet-400">
                        <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 fill-current">
                    ...
                    <a rel="noopener noreferrer" href="#" aria-label="Twitter" className="p-2 rounded-md dark:text-gray-700 hover:dark:text-violet-400">
                        <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 fill-current">
        ...
        /*
                <div className="w-full lg:w-1/4 m-auto mt-12 max-w-screen-sm">
                    <div className="p-4 border-t border-b md:border md:rounded">
                        ...
                        <button className="px-2 py-1 my-2 text-gray-100 bg-green-700 flex w-full items-center justify-center rounded">
