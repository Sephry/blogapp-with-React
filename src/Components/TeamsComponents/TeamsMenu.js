function TeamsMenu(params) {
    ...
    return (
        <div class="flex items-center p-1 border border-blue-600 ">
            ...
            <button class="px-4 py-2 text-sm font-medium text-blue-600 capitalize transition-colors duration-300 md:py-3 focus:outline-none hover:bg-blue-600 hover:text-white rounded-xl md:px-12">development</button>
