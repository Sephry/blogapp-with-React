export default function AboutScreen(params) {
    ...
    return (
        ...
        <div class=" bg-white  flex flex-wrap items-center justify-center">
            <div class="container max-w-lg bg-white rounded  shadow-lg transform duration-200 easy-in-out m-12">
                ...
                <div class="">
                    <div class="px-7 mb-8">
                        <h2 class="text-3xl font-bold text-green-800 ">Beth J. Greene</h2>
                        <p class="text-gray-400 mt-2 ">Illustrator</p>
                        ...
                        <div
                            class="justify-center px-4 py-2 cursor-pointer bg-green-900 max-w-min mx-auto mt-8 rounded-lg text-gray-300 hover:bg-green-800 hover:text-gray-100 ">
